...
from utils.dataset_preprocessing import get_preprocessing_function, parse_dict
from utils.modeling_utils import DataCollatorForBiEncoder, get_model
...
def main():
    ...
    id2label = {str(i): aspect for i, aspect in enumerate(list(labels))}
